...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="gestion.jsp">
            <img src="/ConstructionXpert/resource/Image/freepik__upload__81093-removebg-preview.png" alt="" width="50"
                 height="50">
...
<c:forEach var="tache" items="${taches}">
    ...
    <a href="AddrTache?id=${tache.id_projet}" class="btn btn-success rounded-circle shadow position-fixed"
                    ...
                    <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center w-100">
                        ...
                        <div>
                            ...
                            <ul class="list-unstyled mb-1 small">
                                <li><i class="bi bi-calendar-event me-2"></i><strong>Début
                                    :</strong>${taches.date_debut}</li>
                                <li><i class="bi bi-calendar-check me-2"></i><strong>Fin :</strong>${taches.date_fin}
                                </li>
                            </ul>
                            <p class="small mb-0">
                        ...
                        <div class="mt-3 mt-md-0 d-flex">
                            <a href="/ConstructionXpert/updateTache?id=${taches.id}" type="button"
                               class="btn btn-warning btn-sm me-2">
                                <i class="bi bi-pencil-square"></i>
                            </a>
                            <a href="/ConstructionXpert/deleteTache?id=${taches.id}" type="button" class="btn btn-danger btn-sm">
